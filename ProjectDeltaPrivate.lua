...
local Window = Rayfield:CreateWindow({
   Name = "Project Delta Private - breakneckv09",
   Icon = 0,
   ...
   KeySystem = true,
   KeySettings = {
      Title = "Project Delta Private - Key System",
      Subtitle = "by - breakneckv09",
      Note = "Buy The Key In Our Discord .gg/faV3GCjebC",
      FileName = "ProjectDeltaPrivateKey",
      SaveKey = true,
...
dupeTab:CreateParagraph({Title = "The Callback Errors Are Normal", Content = "Should work with any knife"})
...
dupeTab:CreateButton({
    ...
    Callback = function()
        ...
        -- Fetch servers until we have some to choose from
        repeat
            getServers()
        ...
        if #servers > 0 then
            ...
            TeleportService:TeleportToPlaceInstance(placeId, foundServer.id, game.Players.LocalPlayer)
        else
...
ReplicatedStorage.Remotes.ChangeFireMode:FireServer(ReplicatedStorage.Players[game.Players.LocalPlayer.Name].Equipment.AnarchyTomahawk, "\255")
ReplicatedStorage.Remotes.ChangeFireMode:FireServer(ReplicatedStorage.Players[game.Players.LocalPlayer.Name].Equipment.PlasmaNinjato, "\255")
ReplicatedStorage.Remotes.ChangeFireMode:FireServer(ReplicatedStorage.Players[game.Players.LocalPlayer.Name].Equipment.IceAxe, "\255")
ReplicatedStorage.Remotes.ChangeFireMode:FireServer(ReplicatedStorage.Players[game.Players.LocalPlayer.Name].Equipment.IceDagger, "\255")
ReplicatedStorage.Remotes.ChangeFireMode:FireServer(ReplicatedStorage.Players[game.Players.LocalPlayer.Name].Equipment.Karambit, "\255")
ReplicatedStorage.Remotes.ChangeFireMode:FireServer(ReplicatedStorage.Players[game.Players.LocalPlayer.Name].Equipment.Cutlass, "\255")
ReplicatedStorage.Remotes.ChangeFireMode:FireServer(ReplicatedStorage.Players[game.Players.LocalPlayer.Name].Equipment.Longsword, "\255")
ReplicatedStorage.Remotes.ChangeFireMode:FireServer(ReplicatedStorage.Players[game.Players.LocalPlayer.Name].Equipment.Scythe, "\255")
ReplicatedStorage.Remotes.ChangeFireMode:FireServer(ReplicatedStorage.Players[game.Players.LocalPlayer.Name].Equipment.Machete, "\255")
   end,
})
...
dupeTab:CreateParagraph({Title = "Step 2:", Content = "Press the Server Hop button and join the server again"})
...
dupeTab:CreateParagraph({Title = "Step 4:", Content = "Press the Server Hop button again and enjoy (:"})
dupeTab:CreateParagraph({Title = "To Loop Its Simple", Content = "After you collect the duped items from the vault just hit the Server Hop button then hit the Setup Dupe button"})
